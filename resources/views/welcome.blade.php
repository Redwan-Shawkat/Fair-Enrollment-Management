    ...
    <div
        ...
        <main class="flex w-full max-w-[335px] flex-col-reverse lg:max-w-4xl lg:flex-row">
            <div
                ...
                <h1 class="mb-1 font-medium"> Fair Site </h1>
                ...
                <ul class="mb-4 flex flex-col lg:mb-6">
                    <li
                        ...
                        <span>
                            Showcase authentic company profiles
                        </span>
                    </li>
                    <li
                        class="relative flex items-center gap-4 py-2 before:absolute before:bottom-0 before:left-[0.4rem] before:top-1/2 before:border-l before:border-[#e3e3e0] dark:before:border-[#3E3E3A]">
                        ...
                        <span>
                            Discover companies beyond job listings
                        </span>
                    </li>
                    <li
                        class="relative flex items-center gap-4 py-2 before:absolute before:bottom-0 before:left-[0.4rem] before:top-1/2 before:border-l before:border-[#e3e3e0] dark:before:border-[#3E3E3A]">
                        ...
                        <span>
                            Equal exposure for all companies
                        </span>
                    </li>
                    <li
                        class="relative flex items-center gap-4 py-2 before:absolute before:bottom-0 before:left-[0.4rem] before:top-1/2 before:border-l before:border-[#e3e3e0] dark:before:border-[#3E3E3A]">
                        ...
                        <span>
                            Transparent, trustworthy informationsss
                        </span>
                    </li>
                    <li
                        class="relative flex items-center gap-4 py-2 before:absolute before:bottom-0 before:left-[0.4rem] before:top-1/2 before:border-l before:border-[#e3e3e0] dark:before:border-[#3E3E3A]">
                        ...
                        <span>
                            Designed for genuine connections, not just applications
                        </span>
                    </li>
            ...
            <div
                class="relative -mb-px flex aspect-[335/376] w-full shrink-0 items-center justify-center overflow-hidden rounded-t-lg bg-[#fff2f2] lg:-ml-px lg:mb-0 lg:aspect-auto lg:w-[438px] lg:rounded-r-lg lg:rounded-t-none dark:bg-[#161615]">

                {{-- Fairsite Logo --}}
                <img alt="Logo" src="assets/media/logos/fairlogo-big.svg" class="h-90px w-200px" />
