...
<head>
    ...
    <title>{{ config('app.name', 'Fair Site') }}</title>
...
<body class="font-sans text-gray-900 antialiased">
    <div class="flex min-h-screen flex-col items-center bg-gray-100 pt-6 sm:justify-center sm:pt-0 dark:bg-gray-900">
        <div>
            <a href="/">
                {{-- <img alt="Logo" src="assets/media/logos/fairlogo-small.svg"
                    class="h-20px app-sidebar-logo-minimize" /> --}}
                    <img src="{{ asset('assets/media/logos/fairlogo-small.svg') }}" alt="Logo">
