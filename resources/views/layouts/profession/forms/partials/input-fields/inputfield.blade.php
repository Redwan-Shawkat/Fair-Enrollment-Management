   ...
   <div class="row mb-5">
       ...
       <div class="col-md-6 fv-row">
           ...
           <!--end::Label-->
           <!--begin::Input-->
           <input type="text" class="form-control form-control-solid" placeholder="Profession" name="name" />
           <!--end::Input-->
       </div>
       <!--end::Col-->
       <!--begin::Col-->
       <div class="col-md-6 fv-row">
           ...
           <!--end::Label-->
           <!--begin::Select-->
           <select name="active_status" data-control="select2" data-placeholder="Select the Status.."
