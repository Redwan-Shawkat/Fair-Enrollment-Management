...
<div class="scroll-y mh-325px my-5 px-8">
    ...
    <div class="d-flex flex-stack py-4">
        ...
        <div class="d-flex align-items-center">
            ...
            <!--begin::Title-->
            <div class="mb-0 me-2">
                <a href="#" class="fs-6 text-hover-primary fw-bold text-gray-800">Project
                    Alice</a>
    ...
    <div class="d-flex flex-stack py-4">
        ...
        <div class="d-flex align-items-center">
            ...
            <!--begin::Title-->
            <div class="mb-0 me-2">
                <a href="#" class="fs-6 text-hover-primary fw-bold text-gray-800">HR
                    Confidential</a>
                <div class="fs-7 text-gray-500">
    ...
    <div class="d-flex flex-stack py-4">
        ...
        <div class="d-flex align-items-center">
            ...
            <!--begin::Title-->
            <div class="mb-0 me-2">
                <a href="#" class="fs-6 text-hover-primary fw-bold text-gray-800">Banner
                    Assets</a>
                <div class="fs-7 text-gray-500">
    ...
    <div class="d-flex flex-stack py-4">
        ...
        <div class="d-flex align-items-center">
            ...
            <!--begin::Title-->
            <div class="mb-0 me-2">
                <a href="#" class="fs-6 text-hover-primary fw-bold text-gray-800">Icon
                    Assets</a>
                <div class="fs-7 text-gray-500">
