...
<div id="kt_header_search" class="header-search d-flex align-items-stretch" data-kt-search-keypress="true"
    ...
    <!--end::Search toggle-->
    <!--begin::Menu-->
    <div data-kt-search-element="content" class="menu menu-sub menu-sub-dropdown w-325px w-md-375px p-7">
        <!--begin::Wrapper-->
        <div data-kt-search-element="wrapper">
            <!--begin::Form-->
            <form data-kt-search-element="form" class="w-100 position-relative mb-3" autocomplete="off">
                <!--begin::Icon-->
                <i class="ki-duotone ki-magnifier fs-2 position-absolute top-50 translate-middle-y ms-0 text-gray-500">
                    <span class="path1"></span>
                    <span class="path2"></span>
                </i>
                <!--end::Icon-->
                ...
                <!--end::Input-->
                <!--begin::Spinner-->
                <span class="search-spinner position-absolute top-50 translate-middle-y lh-0 d-none end-0 me-1"
                ...
                <!--end::Reset-->
                <!--begin::Toolbar-->
                <div class="position-absolute top-50 translate-middle-y end-0" data-kt-search-element="toolbar">
            ...
            <div data-kt-search-element="results" class="d-none">
                ...
                <div class="scroll-y mh-200px mh-lg-350px">
                    ...
                    <!--end::Category title-->
                    <!--begin::Item-->
                    <a href="#" class="d-flex text-hover-primary align-items-center mb-5 text-gray-900">
                        <!--begin::Symbol-->
                    ...
                    <!--end::Item-->
                    <!--begin::Category title-->
                    <h3 class="fs-5 text-muted m-0 pb-5 pt-5" data-kt-search-element="category-title">
                        Customers
                    </h3>
                    <!--end::Category title-->
                    <!--begin::Item-->
            ...
            <div class="mb-5" data-kt-search-element="main">
                ...
                <div class="scroll-y mh-200px mh-lg-325px">
                    ...
                    <div class="d-flex align-items-center mb-5">
                        ...
                        <!--begin::Title-->
                        <div class="d-flex flex-column">
                            <a href="#" class="fs-6 text-hover-primary fw-semibold text-gray-800">BoomApp by
                                Keenthemes</a>
                    ...
                    <div class="d-flex align-items-center mb-5">
                        ...
                        <!--begin::Title-->
                        <div class="d-flex flex-column">
                            <a href="#" class="fs-6 text-hover-primary fw-semibold text-gray-800">"Kept API
                                Project Meeting</a>
                    ...
                    <div class="d-flex align-items-center mb-5">
                        ...
                        <!--begin::Title-->
                        <div class="d-flex flex-column">
                            <a href="#" class="fs-6 text-hover-primary fw-semibold text-gray-800">"KPI
                    ...
                    <div class="d-flex align-items-center mb-5">
                        ...
                        <!--begin::Title-->
                        <div class="d-flex flex-column">
                            <a href="#" class="fs-6 text-hover-primary fw-semibold text-gray-800">Project
                                Reference FAQ</a>
                    ...
                    <div class="d-flex align-items-center mb-5">
                        ...
                        <!--begin::Title-->
                        <div class="d-flex flex-column">
                            <a href="#" class="fs-6 text-hover-primary fw-semibold text-gray-800">"FitPro
                                App Development</a>
                            <span class="fs-7 text-muted fw-semibold">#84250</span>
                        </div>
                        <!--end::Title-->
                    ...
                    <div class="d-flex align-items-center mb-5">
                        ...
                        <!--begin::Title-->
                        <div class="d-flex flex-column">
                            <a href="#" class="fs-6 text-hover-primary fw-semibold text-gray-800">Shopix
                                Mobile App</a>
                    ...
                    <div class="d-flex align-items-center mb-5">
                        ...
                        <!--begin::Title-->
                        <div class="d-flex flex-column">
                            <a href="#" class="fs-6 text-hover-primary fw-semibold text-gray-800">"Landing
                                UI Design" Launch</a>
            ...
            <div data-kt-search-element="empty" class="d-none text-center">
                ...
                <div class="pb-15 fw-semibold">
                    <h3 class="fs-5 mb-2 text-gray-600">
                        No result found
                    </h3>
        ...
        <form data-kt-search-element="advanced-options-form" class="d-none pt-1">
            <!--begin::Heading-->
            <h3 class="fw-semibold mb-7 text-gray-900">
                Advanced Search
            </h3>
            <!--end::Heading-->
            <!--begin::Input group-->
        ...
        <form data-kt-search-element="preferences" class="d-none pt-1">
            ...
            <div class="border-bottom pb-4">
                <label class="form-check form-switch form-switch-sm form-check-custom form-check-solid flex-stack">
                    <span class="form-check-label fs-6 fw-semibold me-2 ms-0 text-gray-700">Projects</span>
            ...
            <div class="border-bottom py-4">
                <label class="form-check form-switch form-switch-sm form-check-custom form-check-solid flex-stack">
                    <span class="form-check-label fs-6 fw-semibold me-2 ms-0 text-gray-700">Targets</span>
                    <input class="form-check-input" type="checkbox" value="1" checked="checked" />
                </label>
            </div>
            <!--end::Input group-->
            ...
            <div class="border-bottom py-4">
                <label class="form-check form-switch form-switch-sm form-check-custom form-check-solid flex-stack">
                    <span class="form-check-label fs-6 fw-semibold me-2 ms-0 text-gray-700">Affiliate
                        Programs</span>
            ...
            <div class="border-bottom py-4">
                <label class="form-check form-switch form-switch-sm form-check-custom form-check-solid flex-stack">
                    <span class="form-check-label fs-6 fw-semibold me-2 ms-0 text-gray-700">Referrals</span>
                    <input class="form-check-input" type="checkbox" value="1" checked="checked" />
                </label>
            </div>
            <!--end::Input group-->
            ...
            <div class="border-bottom py-4">
                <label class="form-check form-switch form-switch-sm form-check-custom form-check-solid flex-stack">
                    <span class="form-check-label fs-6 fw-semibold me-2 ms-0 text-gray-700">Users</span>
                    <input class="form-check-input" type="checkbox" value="1" />
                </label>
            </div>
            <!--end::Input group-->
