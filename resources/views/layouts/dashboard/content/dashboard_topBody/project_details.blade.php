    ...
    ">
            ...
            <div class="card-body d-flex align-items-end pt-0">
                ...
                <div class="d-flex align-items-center flex-column w-100 mt-3">
                    <div class="d-flex justify-content-between fw-bold fs-6 w-100 mb-2 mt-auto text-white opacity-75">
                        <span>43 Pending</span>
                        <span>72%</span>
                    </div>
                    <div class="h-8px w-100 mx-3 rounded bg-white bg-opacity-50">
                        <div class="h-8px rounded bg-white" role="progressbar" style="width: 72%" aria-valuenow="50"
            ...
            <div class="card-header pt-5">
                ...
                <div class="card-title d-flex flex-column">
                    ...
                    <div class="d-flex align-items-center">
                        <!--begin::Currency-->
                        <span class="fs-4 fw-semibold align-self-start me-1 text-gray-500">$</span>
                        <!--end::Currency-->
                        <!--begin::Amount-->
                    ...
                    <div class="fs-2hx fw-bold mb-13 text-center text-gray-800">
                        <span class="me-2">Try our all new Enviroment with
                            ...
                            <span class="position-relative d-inline-block text-danger">
                                <a href="pages/user-profile/overview.html" class="text-danger opacity-75-hover">Pro
                                    Plan</a>
                                <!--begin::Separator-->
                                <span
