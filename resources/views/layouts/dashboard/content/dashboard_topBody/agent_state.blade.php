        ...
        <div class="card-header mb-6 pt-5">
            ...
            <h3 class="card-title align-items-start flex-column">
                ...
                <div class="d-flex align-items-center mb-2">
                    <!--begin::Currency-->
                    <span class="fs-3 fw-semibold align-self-start me-1 text-gray-500">$</span>
                    <!--end::Currency-->
                    <!--begin::Value-->
                    ...
                    <div class="table-responsive mt-n6 mx-9">
                        ...
                        <table class="gs-0 gy-4 table align-middle">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <a href="#" class="fw-bold fs-6 text-gray-600">2:30 PM</a>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <a href="#" class="fw-bold fs-6 text-gray-600">3:10 PM</a>
                                    </td>
                                    <td class="pe-0 text-end">
                                ...
                                <tr>
                                    <td>
                                        <a href="#" class="fw-bold fs-6 text-gray-600">3:55 PM</a>
                                    </td>
                                    <td class="pe-0 text-end">
                    ...
                    <div class="table-responsive mt-n6 mx-9">
                        ...
                        <table class="gs-0 gy-4 table align-middle">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <a href="#" class="fw-bold fs-6 text-gray-600">4:30 PM</a>
                                    </td>
                                    <td class="pe-0 text-end">
                                ...
                                <tr>
                                    <td>
                                        <a href="#" class="fw-bold fs-6 text-gray-600">3:30 PM</a>
                                    </td>
                                    <td class="pe-0 text-end">
                    ...
                    <div class="table-responsive mt-n6 mx-9">
                        ...
                        <table class="gs-0 gy-4 table align-middle">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <a href="#" class="fw-bold fs-6 text-gray-600">3:20 AM</a>
                                    </td>
                                    <td class="pe-0 text-end">
                    ...
                    <div class="table-responsive mt-n6 mx-9">
                        ...
                        <table class="gs-0 gy-4 table align-middle">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <a href="#" class="fw-bold fs-6 text-gray-600">5:30 AM</a>
                                    </td>
                                    <td class="pe-0 text-end">
                                        <span class="fw-bold fs-6 me-1 text-gray-800">$1,756.26</span>
                                    </td>
                    ...
                    <div class="table-responsive mt-n6 mx-9">
                        ...
                        <table class="gs-0 gy-4 table align-middle">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <a href="#" class="fw-bold fs-6 text-gray-600">3:30 AM</a>
                                    </td>
                                    <td class="pe-0 text-end">
                                        <span class="fw-bold fs-6 me-1 text-gray-800">$756.26</span>
                                    </td>
