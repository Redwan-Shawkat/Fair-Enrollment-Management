                            ...
                            ">
                                    ...
                                    <div class="card-header pt-5">
                                        ...
                                        <div class="card-title d-flex flex-column">
                                            ...
                                            <!--end::Amount-->
                                            <!--begin::Subtitle-->
                                            <span class="fw-semibold fs-6 pt-1 text-white opacity-75">Active
                                                Projects</span>
                                            <!--end::Subtitle-->
                                        </div>
                                        <!--end::Title-->
                                ...
                                <div class="card card-flush h-md-50 mb-xl-10 mb-5">
                                    ...
                                    <div class="card-header pt-5">
                                        ...
                                        <div class="card-title d-flex flex-column">
                                            <!--begin::Amount-->
                                            <span class="fs-2hx fw-bold lh-1 ls-n2 me-2 text-gray-900">357</span>
                                            <!--end::Amount-->
                                            <!--begin::Subtitle-->
                                            <span class="fw-semibold fs-6 pt-1 text-gray-500">Professionals</span>
                                            <!--end::Subtitle-->
                                        </div>
                                        <!--end::Title-->
                                    </div>
                                    ...
                                    <div class="card-header pt-5">
                                        ...
                                        <div class="card-title d-flex flex-column">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <!--begin::Currency-->
                                                <span
                                                    class="fs-4 fw-semibold align-self-start me-1 text-gray-500">$</span>
                                                <!--end::Currency-->
                                                <!--begin::Amount-->
                                                <span class="fs-2hx fw-bold lh-1 ls-n2 me-2 text-gray-900">69,700</span>
                                                <!--end::Amount-->
                                                <!--begin::Badge-->
                                            ...
                                            <!--end::Info-->
                                            <!--begin::Subtitle-->
                                            <span class="fw-semibold fs-6 pt-1 text-gray-500">Projects Earnings in
                                                April</span>
                                            <!--end::Subtitle-->
                                        </div>
                                        <!--end::Title-->
                                    ...
                                    <div class="card-body d-flex align-items-center flex-wrap pb-4 pt-2">
                                        ...
                                        <div class="d-flex flex-column content-justify-center flex-row-fluid">
                                            ...
                                            <div class="d-flex fw-semibold align-items-center">
                                                ...
                                                <!--end::Bullet-->
                                                <!--begin::Label-->
                                                <div class="flex-grow-1 me-4 text-gray-500">
                                                    Leaf CRM
                                                </div>
                                                <!--end::Label-->
                                                <!--begin::Stats-->
                                ...
                                <div class="card card-flush h-lg-50">
                                    ...
                                    <div class="card-header pt-5">
                                        ...
                                        <div class="card-toolbar">
                                            ...
                                            <button
                                                ...
                                                <i class="ki-duotone ki-dots-square fs-1 me-n1 text-gray-500">
                                                    <span class="path1"></span>
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px"
                                                ...
                                                <div class="menu-item px-3">
                                                    <div class="menu-content fs-6 fw-bold px-3 py-4 text-gray-900">
                                                        Quick Actions
                                                    </div>
                                                </div>
                                                <!--end::Menu item-->
                                    ...
                                    <div class="card-body pt-5">
                                        ...
                                        <div class="d-flex flex-stack">
                                            ...
                                            <!--begin::Action-->
                                            <button type="button"
                                                class="btn btn-icon btn-sm btn-color-gray-500 btn-active-color-primary justify-content-end h-auto">
                                            ...
                                            <div class="fs-2hx fw-bold mb-13 text-center text-gray-800">
                                                <span class="me-2">Try our all new Enviroment with
                                                    ...
                                                    <span class="position-relative d-inline-block text-danger">
                                                        ...
                                                        <!--begin::Separator-->
                                                        <span
                                                            class="position-absolute border-danger border-bottom w-100 bottom-0 start-0 border-4 opacity-15"></span>
                                                        <!--end::Separator-->
                                                    </span></span>for Free
                                            </div>
                                            <!--end::Title-->
                                ...
                                <div class="card card-flush h-xl-100">
                                    ...
                                    <div class="card-header pt-5">
                                        ...
                                        <h3 class="card-title align-items-start flex-column">
                                            ...
                                            <span class="fw-semibold fs-6 mt-1 text-gray-500">Users from all
                                                channels</span>
                                        </h3>
                                        <!--end::Title-->
                                        <!--begin::Toolbar-->
                                            ...
                                            <div class="tab-pane fade" id="kt_chart_widget_8_week_tab"
                                                ...
                                                <div class="mb-5">
                                                    ...
                                                    <div class="d-flex align-items-center mb-2">
                                                        <span
                                                            class="fs-1 fw-semibold mt-n1 me-1 text-gray-500">$</span>
                                                        <span
                                                            class="fs-3x fw-bold lh-1 ls-n2 me-2 text-gray-800">18,89</span>
                                                        <span class="badge badge-light-success fs-base">
                                                            <i class="ki-duotone ki-arrow-up fs-5 text-success ms-n1">
                                                                <span class="path1"></span>
                                                ...
                                                <div class="d-flex flex-wrap pt-5">
                                                    ...
                                                    <div class="d-flex flex-column me-lg-16 pt-sm-3 me-7 pt-6">
                                                        ...
                                                        <div class="d-flex align-items-center mb-sm-6 mb-3">
                                                            <!--begin::Bullet-->
                                                            <span
                                                                class="bullet bullet-dot bg-primary h-10px w-10px me-2"></span>
                                                            <!--end::Bullet-->
                                                            <!--begin::Label-->
                                                            <span class="fw-bold fs-6 text-gray-600">Social
                                                                Campaigns</span>
                                                            <!--end::Label-->
                                                        </div>
                                                        <!--ed::Item-->
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            <!--begin::Bullet-->
                                                            <span
                                                                class="bullet bullet-dot bg-danger h-10px w-10px me-2"></span>
                                                            <!--end::Bullet-->
                                                            <!--begin::Label-->
                                                    ...
                                                    <div class="d-flex flex-column me-lg-16 pt-sm-3 me-7 pt-6">
                                                        ...
                                                        <div class="d-flex align-items-center mb-sm-6 mb-3">
                                                            <!--begin::Bullet-->
                                                            <span
                                                                class="bullet bullet-dot bg-success h-10px w-10px me-2"></span>
                                                            <!--end::Bullet-->
                                                            <!--begin::Label-->
                                                            <span class="fw-bold fs-6 text-gray-600">Email
                                                                Newsletter</span>
                                                            <!--end::Label-->
                                                        </div>
                                                        <!--ed::Item-->
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            <!--begin::Bullet-->
                                                            <span
                                                                class="bullet bullet-dot bg-warning h-10px w-10px me-2"></span>
                                                            <!--end::Bullet-->
                                                            <!--begin::Label-->
                                                    ...
                                                    <div class="d-flex flex-column pt-sm-3 pt-6">
                                                        ...
                                                        <div class="d-flex align-items-center mb-sm-6 mb-3">
                                                            <!--begin::Bullet-->
                                                            <span
                                                                class="bullet bullet-dot bg-info h-10px w-10px me-2"></span>
                                                            <!--end::Bullet-->
                                                            <!--begin::Label-->
                                                ...
                                                <div class="mb-5">
                                                    ...
                                                    <div class="d-flex align-items-center mb-2">
                                                        <span
                                                            class="fs-1 fw-semibold mt-n1 me-1 text-gray-500">$</span>
                                                        <span
                                                            class="fs-3x fw-bold lh-1 ls-n2 me-2 text-gray-800">8,55</span>
                                                        <span class="badge badge-light-success fs-base">
                                                            <i class="ki-duotone ki-arrow-up fs-5 text-success ms-n1">
                                                                <span class="path1"></span>
                                                                <span class="path2"></span> </i>2.2%</span>
                                ...
                                <div class="card card-flush h-xl-100">
                                    ...
                                    <div class="card-header pt-5">
                                        ...
                                        <h3 class="card-title align-items-start flex-column">
                                            ...
                                            <span class="fw-semibold fs-6 mt-1 text-gray-500">Avg. 69.34% Conv.
                                                Rate</span>
                                        </h3>
                                        <!--end::Title-->
                                        <!--begin::Toolbar-->
                                        ...
                                        <ul class="nav nav-pills nav-pills-custom mb-3">
                                            ...
                                            <li class="nav-item me-lg-6 mb-3 me-3">
                                                ...
                                                <a class="nav-link btn btn-outline btn-flex btn-color-muted btn-active-color-primary flex-column w-80px h-85px overflow-hidden pb-2 pt-5"
                                                    ...
                                                    <!--begin::Title-->
                                                    <span
                                                        class="nav-text fw-bold fs-6 lh-1 text-gray-800">Crypto</span>
                                                    <!--end::Title-->
                                                    <!--begin::Bullet-->
                                                    <span
                                                        class="bullet-custom position-absolute w-100 h-4px bg-primary bottom-0"></span>
                                            ...
                                            <li class="nav-item me-lg-6 mb-3 me-3">
                                                ...
                                                <a class="nav-link btn btn-outline btn-flex btn-color-muted btn-active-color-primary flex-column w-80px h-85px overflow-hidden pb-2 pt-5"
                                                    ...
                                                    <!--begin::Title-->
                                                    <span
                                                        class="nav-text fw-bold fs-6 lh-1 text-gray-800">Social</span>
                                                    <!--end::Title-->
                                                    <!--begin::Bullet-->
                                                    <span
                                                        class="bullet-custom position-absolute w-100 h-4px bg-primary bottom-0"></span>
                                            ...
                                            <li class="nav-item me-lg-6 mb-3 me-3">
                                                ...
                                                <a class="nav-link btn btn-outline btn-flex btn-color-muted btn-active-color-primary flex-column w-80px h-85px overflow-hidden pb-2 pt-5"
                                                    ...
                                                    <!--begin::Title-->
                                                    <span
                                                        class="nav-text fw-bold fs-6 lh-1 text-gray-800">Mobile</span>
                                                    <!--end::Title-->
                                                    <!--begin::Bullet-->
                                                    <span
                                                        class="bullet-custom position-absolute w-100 h-4px bg-primary bottom-0"></span>
                                            ...
                                            <li class="nav-item me-lg-6 mb-3 me-3">
                                                ...
                                                <a class="nav-link btn btn-outline btn-flex btn-color-muted btn-active-color-primary flex-column w-80px h-85px overflow-hidden pb-2 pt-5"
                                                    ...
                                                    <!--begin::Title-->
                                                    <span
                                                        class="nav-text fw-bold fs-6 lh-1 text-gray-800">Others</span>
                                                    <!--end::Title-->
                                                    <!--begin::Bullet-->
                                                    <span
                                                        class="bullet-custom position-absolute w-100 h-4px bg-primary bottom-0"></span>
                                                    ...
                                                    <table class="table-row-dashed gs-0 gy-3 my-0 table align-middle">
                                                        ...
                                                        <thead>
                                                            <tr class="fs-7 fw-bold border-bottom-0 text-gray-500">
                                                                <th class="min-w-150px p-0 pb-3 text-start">
                                                                    AUTHOR
                                                                </th>
                                                                <th class="min-w-100px pe-13 p-0 pb-3 text-end">
                                                                    CONV.
                                                                </th>
                                                                <th class="w-125px p-0 pb-3 pe-7 text-end">
                                                                    CHART
                                                                </th>
                                                                <th class="w-50px p-0 pb-3 text-end">
                                                                    VIEW
                                                                </th>
                                                            </tr>
                                                        </thead>
                                                                    ...
                                                                    <div class="d-flex align-items-center">
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <a href="pages/user-profile/overview.html"
                                                                                ...
                                                                                Hawkins</a>
                                                                            <span
                                                                                class="fw-semibold d-block fs-7 text-gray-500">Haiti</span>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                                <td class="pe-13 text-end">
                                                                    <span
                                                                        class="fw-bold fs-6 text-gray-600">78.34%</span>
                                                                </td>
                                                                    ...
                                                                    <div class="d-flex align-items-center">
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <a href="pages/user-profile/overview.html"
                                                                                ...
                                                                                Cooper</a>
                                                                            <span
                                                                                class="fw-semibold d-block fs-7 text-gray-500">Monaco</span>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                                <td class="pe-13 text-end">
                                                                    <span
                                                                        class="fw-bold fs-6 text-gray-600">63.83%</span>
                                                                </td>
                                                                <td class="pe-0 text-end">
                                                                    ...
                                                                    <div class="d-flex align-items-center">
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <a href="pages/user-profile/overview.html"
                                                                                ...
                                                                                Jones</a>
                                                                            <span
                                                                                class="fw-semibold d-block fs-7 text-gray-500">Poland</span>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                                <td class="pe-13 text-end">
                                                                    <span
                                                                        class="fw-bold fs-6 text-gray-600">92.56%</span>
                                                                </td>
                                                                <td class="pe-0 text-end">
                                                                    ...
                                                                    <div class="d-flex align-items-center">
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <a href="pages/user-profile/overview.html"
                                                                                ...
                                                                                Fishers</a>
                                                                            <span
                                                                                class="fw-semibold d-block fs-7 text-gray-500">Mexico</span>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                                <td class="pe-13 text-end">
                                                                    <span
                                                                        class="fw-bold fs-6 text-gray-600">63.08%</span>
                                                                </td>
                                                                <td class="pe-0 text-end">
                                                    ...
                                                    <table class="table-row-dashed gs-0 gy-3 my-0 table align-middle">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td class="pe-13 text-end">
                                                                    <span
                                                                        class="fw-bold fs-6 text-gray-600">85.23%</span>
                                                                </td>
                                                                <td class="pe-0 text-end">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="pe-13 text-end">
                                                                    <span
                                                                        class="fw-bold fs-6 text-gray-600">74.83%</span>
                                                                </td>
                                                                <td class="pe-0 text-end">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="pe-13 text-end">
                                                                    <span
                                                                        class="fw-bold fs-6 text-gray-600">90.06%</span>
                                                                </td>
                                                                <td class="pe-0 text-end">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="pe-13 text-end">
                                                                    <span
                                                                        class="fw-bold fs-6 text-gray-600">54.08%</span>
                                                                </td>
                                                                <td class="pe-0 text-end">
                                                    ...
                                                    <table class="table-row-dashed gs-0 gy-3 my-0 table align-middle">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                    ...
                                                                    <div class="d-flex align-items-center">
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <a href="pages/user-profile/overview.html"
                                                                                ...
                                                                                Jones</a>
                                                                            <span
                                                                                class="fw-semibold d-block fs-7 text-gray-500">New
                                                                                York</span>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                                <td class="pe-13 text-end">
                                                                    <span
                                                                        class="fw-bold fs-6 text-gray-600">52.34%</span>
                                                                </td>
                                                                <td class="pe-0 text-end">
                                                                    ...
                                                                    <div class="d-flex align-items-center">
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <a href="pages/user-profile/overview.html"
                                                                                ...
                                                                                Richards</a>
                                                                            <span
                                                                                class="fw-semibold d-block fs-7 text-gray-500">Madrid</span>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                                <td class="pe-13 text-end">
                                                                    <span
                                                                        class="fw-bold fs-6 text-gray-600">77.65%</span>
                                                                </td>
                                                                <td class="pe-0 text-end">
                                                                    ...
                                                                    <div class="d-flex align-items-center">
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <a href="pages/user-profile/overview.html"
                                                                                ...
                                                                                Alexander</a>
                                                                            <span
                                                                                class="fw-semibold d-block fs-7 text-gray-500">Pune</span>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                                <td class="pe-13 text-end">
                                                                    <span
                                                                        class="fw-bold fs-6 text-gray-600">82.47%</span>
                                                                </td>
                                                                <td class="pe-0 text-end">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="pe-13 text-end">
                                                                    <span
                                                                        class="fw-bold fs-6 text-gray-600">67.84%</span>
                                                                </td>
                                                                <td class="pe-0 text-end">
                                                    ...
                                                    <table class="table-row-dashed gs-0 gy-3 my-0 table align-middle">
                                                        ...
                                                        <tbody>
                                                                    ...
                                                                    <div class="d-flex align-items-center">
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <a href="pages/user-profile/overview.html"
                                                                                ...
                                                                                McCoy</a>
                                                                            <span
                                                                                class="fw-semibold d-block fs-7 text-gray-500">London</span>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                                <td class="pe-13 text-end">
                                                                    <span
                                                                        class="fw-bold fs-6 text-gray-600">53.44%</span>
                                                                </td>
                                                                <td class="pe-0 text-end">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="pe-13 text-end">
                                                                    <span
                                                                        class="fw-bold fs-6 text-gray-600">74.64%</span>
                                                                </td>
                                                                <td class="pe-0 text-end">
                                                                    ...
                                                                    <div class="d-flex align-items-center">
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <a href="pages/user-profile/overview.html"
                                                                                ...
                                                                                Jones</a>
                                                                            <span
                                                                                class="fw-semibold d-block fs-7 text-gray-500">PManila</span>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                                <td class="pe-13 text-end">
                                                                    <span
                                                                        class="fw-bold fs-6 text-gray-600">88.56%</span>
                                                                </td>
                                                                <td class="pe-0 text-end">
                                                                    ...
                                                                    <div class="d-flex align-items-center">
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <a href="pages/user-profile/overview.html"
                                                                                ...
                                                                                Howard</a>
                                                                            <span
                                                                                class="fw-semibold d-block fs-7 text-gray-500">Iceland</span>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                                <td class="pe-13 text-end">
                                                                    <span
                                                                        class="fw-bold fs-6 text-gray-600">63.16%</span>
                                                                </td>
                                                                <td class="pe-0 text-end">
                                                    ...
                                                    <table class="table-row-dashed gs-0 gy-3 my-0 table align-middle">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td class="pe-13 text-end">
                                                                    <span
                                                                        class="fw-bold fs-6 text-gray-600">68.54%</span>
                                                                </td>
                                                                <td class="pe-0 text-end">
                                                                    ...
                                                                    <div class="d-flex align-items-center">
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <a href="pages/user-profile/overview.html"
                                                                                ...
                                                                                Howard</a>
                                                                            <span
                                                                                class="fw-semibold d-block fs-7 text-gray-500">Kiribati</span>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                                <td class="pe-13 text-end">
                                                                    <span
                                                                        class="fw-bold fs-6 text-gray-600">55.83%</span>
                                                                </td>
                                                                <td class="pe-0 text-end">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="pe-13 text-end">
                                                                    <span
                                                                        class="fw-bold fs-6 text-gray-600">93.46%</span>
                                                                </td>
                                                                <td class="pe-0 text-end">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="pe-13 text-end">
                                                                    <span
                                                                        class="fw-bold fs-6 text-gray-600">64.48%</span>
                                                                </td>
                                                                <td class="pe-0 text-end">
                                    ...
                                    ">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <div class="d-flex flex-column h-100">
                                                    ...
                                                    <div class="mb-7">
                                                        ...
                                                        <div class="d-flex flex-stack mb-6">
                                                            ...
                                                            <div class="me-5 flex-shrink-0">
                                                                <span
                                                                    class="fs-7 fw-bold d-block lh-1 me-2 pb-1 text-gray-500">Featured</span>
                                                                <span class="fs-1 fw-bold text-gray-800">9
                                                                    Degree</span>
                                                            </div>
                                                            <!--end::Title-->
                                                            <span
                                                        ...
                                                        <div class="d-flex align-items-center d-grid flex-wrap gap-2">
                                                            ...
                                                            <div class="d-flex align-items-center me-xl-13 me-5">
                                                                ...
                                                                <div class="m-0">
                                                                    <span
                                                                        class="fw-semibold d-block fs-8 text-gray-500">Manager</span>
                                                                    <a href="pages/user-profile/overview.html"
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="m-0">
                                                                    <span
                                                                        class="fw-semibold d-block fs-8 text-gray-500">Budget</span>
                                                                    <span
                                                                        class="fw-bold fs-7 text-gray-800">$64.800</span>
                                                                </div>
                                                                <!--end::Info-->
                                                            </div>
                                                            <!--end::Item-->
                                                    ...
                                                    <div class="mb-6">
                                                        <!--begin::Text-->
                                                        <span class="fw-semibold fs-6 d-block mb-8 text-gray-600">Flat
                                                            cartoony illustrations with vivid
                                                        ...
                                                        <div class="d-flex">
                                                            ...
                                                            <div
                                                                ...
                                                                <!--begin::Date-->
                                                                <span class="fs-6 fw-bold text-gray-700">Feb 6,
                                                                    2021</span>
                                                                <!--end::Date-->
                                                                <!--begin::Label-->
                                ...
                                <div class="card card-flush h-lg-100 overflow-hidden">
                                    ...
                                    <div class="card-header pt-5">
                                        ...
                                        <h3 class="card-title align-items-start flex-column">
                                            ...
                                            <span class="fw-semibold fs-6 mt-1 text-gray-500">1,046 Inbound Calls
                                                today</span>
                                        </h3>
                                        <!--end::Title-->
                                        <!--begin::Toolbar-->
                                        <div class="card-toolbar">
                                            ...
                                            <div data-kt-daterangepicker="true" data-kt-daterangepicker-opens="left"
                                                ...
                                                <!--end::Display range-->
                                                <i class="ki-duotone ki-calendar-8 lh-0 fs-2 me-0 ms-2 text-gray-500">
                                                    <span class="path1"></span>
                                                    <span class="path2"></span>
                                                    <span class="path3"></span>
                                                    <span class="path4"></span>
                                    ...
                                    <div class="card-body d-flex align-items-end p-0">
                                        <!--begin::Chart-->
                                        <div id="kt_charts_widget_36" class="min-h-auto w-100 pe-6 ps-4"
                                    ...
                                    <div class="card-header mb-6 pt-5">
                                        ...
                                        <h3 class="card-title align-items-start flex-column">
                                            ...
                                            <div class="d-flex align-items-center mb-2">
                                                <!--begin::Currency-->
                                                <span
                                                    class="fs-3 fw-semibold align-self-start me-1 text-gray-500">$</span>
                                                <!--end::Currency-->
                                                <!--begin::Value-->
                                                <span
                                                    class="fs-2hx fw-bold lh-1 ls-n2 me-2 text-gray-800">3,274.94</span>
                                                <!--end::Value-->
                                                <!--begin::Label-->
                                                <span class="badge badge-light-success fs-base">
                                                    <i class="ki-duotone ki-arrow-up fs-5 text-success ms-n1">
                                                    ...
                                                    <table class="gs-0 gy-4 table align-middle">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td>
                                                                    <a href="#"
                                                                        class="fw-bold fs-6 text-gray-600">2:30 PM</a>
                                                                </td>
                                                                <td class="pe-0 text-end">
                                                                    <span
                                                                        class="fw-bold fs-6 me-1 text-gray-800">$2,756.26</span>
                                                                </td>
                                                                <td class="pe-0 text-end">
                                                                    <span
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <a href="#"
                                                                        class="fw-bold fs-6 text-gray-600">3:10 PM</a>
                                                                </td>
                                                                <td class="pe-0 text-end">
                                                                    <span
                                                                        class="fw-bold fs-6 me-1 text-gray-800">$3,207.03</span>
                                                                </td>
                                                                <td class="pe-0 text-end">
                                                                    <span
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <a href="#"
                                                                        class="fw-bold fs-6 text-gray-600">3:55 PM</a>
                                                                </td>
                                                                <td class="pe-0 text-end">
                                                                    <span
                                                                        class="fw-bold fs-6 me-1 text-gray-800">$3,274.94</span>
                                                                </td>
                                                                <td class="pe-0 text-end">
                                                                    <span
                                                    ...
                                                    <table class="gs-0 gy-4 table align-middle">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td>
                                                                    <a href="#"
                                                                        class="fw-bold fs-6 text-gray-600">4:30 PM</a>
                                                                </td>
                                                                <td class="pe-0 text-end">
                                                                    <span
                                                                        class="fw-bold fs-6 me-1 text-gray-800">$2,345.45</span>
                                                                </td>
                                                                <td class="pe-0 text-end">
                                                                    <span
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <a href="#"
                                                                        class="fw-bold fs-6 text-gray-600">11:35
                                                                        AM</a>
                                                                </td>
                                                                <td class="pe-0 text-end">
                                                                    <span
                                                                        class="fw-bold fs-6 me-1 text-gray-800">$756.26</span>
                                                                </td>
                                                                <td class="pe-0 text-end">
                                                                    <span
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <a href="#"
                                                                        class="fw-bold fs-6 text-gray-600">3:30 PM</a>
                                                                </td>
                                                                <td class="pe-0 text-end">
                                                                    <span
                                                                        class="fw-bold fs-6 me-1 text-gray-800">$1,756.26</span>
                                                                </td>
                                                                <td class="pe-0 text-end">
                                                                    <span
                                                    ...
                                                    <table class="gs-0 gy-4 table align-middle">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td>
                                                                    <a href="#"
                                                                        class="fw-bold fs-6 text-gray-600">3:20 AM</a>
                                                                </td>
                                                                <td class="pe-0 text-end">
                                                                    <span
                                                                        class="fw-bold fs-6 me-1 text-gray-800">$3,756.26</span>
                                                                </td>
                                                                <td class="pe-0 text-end">
                                                                    <span
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <a href="#"
                                                                        class="fw-bold fs-6 text-gray-600">12:30
                                                                        AM</a>
                                                                </td>
                                                                <td class="pe-0 text-end">
                                                                    <span
                                                    ...
                                                    <table class="gs-0 gy-4 table align-middle">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <a href="#"
                                                                        class="fw-bold fs-6 text-gray-600">5:30 AM</a>
                                                                </td>
                                                                <td class="pe-0 text-end">
                                                                    <span
                                                                        class="fw-bold fs-6 me-1 text-gray-800">$1,756.26</span>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="pe-0 text-end">
                                                                    <span
                                                                        class="fw-bold fs-6 me-1 text-gray-800">$2,085.25</span>
                                                                </td>
                                                                <td class="pe-0 text-end">
                                                                    <span
                                                    ...
                                                    <table class="gs-0 gy-4 table align-middle">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td class="pe-0 text-end">
                                                                    <span
                                                                        class="fw-bold fs-6 me-1 text-gray-800">$2,045.04</span>
                                                                </td>
                                                                <td class="pe-0 text-end">
                                                                    <span
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <a href="#"
                                                                        class="fw-bold fs-6 text-gray-600">3:30 AM</a>
                                                                </td>
                                                                <td class="pe-0 text-end">
                                                                    <span
                                                                        class="fw-bold fs-6 me-1 text-gray-800">$756.26</span>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <a href="#"
                                                                        class="fw-bold fs-6 text-gray-600">10:30
                                                                        PM</a>
                                                                </td>
                                                                <td class="pe-0 text-end">
                                                                    <span
                                ...
                                <div class="card card-flush h-md-100">
                                    ...
                                    <div class="card-header pt-7">
                                        ...
                                        <h3 class="card-title align-items-start flex-column">
                                            ...
                                            <span class="fw-semibold fs-6 mt-1 text-gray-500">Updated 37 minutes
                                                ago</span>
                                        </h3>
                                        <!--end::Title-->
                                        <!--begin::Toolbar-->
                                    ...
                                    <div class="card-body pt-6">
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <table class="table-row-dashed gs-0 gy-3 my-0 table align-middle">
                                                ...
                                                <thead>
                                                    <tr class="fs-7 fw-bold border-bottom-0 text-gray-500">
                                                        <th class="min-w-175px p-0 pb-3 text-start">
                                                            ITEM
                                                        </th>
                                                        <th class="min-w-100px p-0 pb-3 text-end">
                                                            BUDGET
                                                        </th>
                                                        <th class="min-w-100px p-0 pb-3 text-end">
                                                            PROGRESS
                                                        </th>
                                                        <th class="min-w-175px p-0 pb-3 pe-12 text-end">
                                                            STATUS
                                                        </th>
                                                        <th class="w-125px p-0 pb-3 pe-7 text-end">
                                                            CHART
                                                ...
                                                <tbody>
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="d-flex justify-content-start flex-column">
                                                                    <a href="#"
                                                                        ...
                                                                        App</a>
                                                                    <span
                                                                        class="fw-semibold d-block fs-7 text-gray-500">Jane
                                                                        Cooper</span>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="d-flex justify-content-start flex-column">
                                                                    ...
                                                                    <span
                                                                        class="fw-semibold d-block fs-7 text-gray-500">Esther
                                                                        Howard</span>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        ...
                                                        <td class="pe-12 text-end">
                                                            <span class="badge fs-7 badge-light-warning px-4 py-3">On
                                                                Hold</span>
                                                        </td>
                                                        <td class="pe-0 text-end">
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="d-flex justify-content-start flex-column">
                                                                    <a href="#"
                                                                        ...
                                                                        CRM</a>
                                                                    <span
                                                                        class="fw-semibold d-block fs-7 text-gray-500">Jenny
                                                                        Wilson</span>
                                                                </div>
                                                            </div>
                                                        </td>
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="d-flex justify-content-start flex-column">
                                                                    <a href="#"
                                                                        ...
                                                                        Hill</a>
                                                                    <span
                                                                        class="fw-semibold d-block fs-7 text-gray-500">Cody
                                                                        Fisher</span>
                                                                </div>
                                                            </div>
                                                        </td>
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="d-flex justify-content-start flex-column">
                                                                    <a href="#"
                                                                        ...
                                                                        Degree</a>
                                                                    <span
                                                                        class="fw-semibold d-block fs-7 text-gray-500">Savannah
                                                                        Nguyen</span>
                                                                </div>
                                                            </div>
                                                        </td>
                                ...
                                <div class="card card-flush h-xl-100">
                                    ...
                                    <div class="card-header mb-7 pt-7">
                                        ...
                                        <h3 class="card-title align-items-start flex-column">
                                            ...
                                            <span class="fw-semibold fs-6 mt-1 text-gray-500">8k social
                                                visitors</span>
                                        </h3>
                                        <!--end::Title-->
                                        <!--begin::Toolbar-->
                                ...
                                <div class="card card-flush h-xl-100 overflow-hidden">
                                    ...
                                    <div class="card-header py-5">
                                        ...
                                        <h3 class="card-title align-items-start flex-column">
                                            ...
                                            <span class="fw-semibold fs-6 mt-1 text-gray-500">Reports by states and
                                                ganders</span>
                                        </h3>
                                        <!--end::Title-->
                                        <!--begin::Toolbar-->
