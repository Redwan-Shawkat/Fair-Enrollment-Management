 ...
 <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
     ...
     <div class="page-title d-flex flex-column justify-content-center me-3 flex-wrap">
         <!--begin::Title-->
         <h1 class="page-heading d-flex fw-bold fs-3 flex-column justify-content-center my-0 text-gray-900">Tables
         </h1>
         <!--end::Title-->
         <!--begin::Breadcrumb-->
         <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
             ...
             <li class="breadcrumb-item text-muted">
                 <a href="/organization" class="text-muted text-hover-primary">Organization</a>
             </li>
             <!--end::Item-->
             <!--begin::Item-->
                     ...
                     <div class="mb-10">
                         ...
                         <div>
                             <select class="form-select form-select-solid" multiple="multiple" data-kt-select2="true"
                                 ...
                                 data-dropdown-parent="#kt_menu_673c0c969aef6" data-allow-clear="true">
                                 <option></option>
