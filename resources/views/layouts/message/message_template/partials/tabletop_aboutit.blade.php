<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
        ...
        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
            ...
            <li class="breadcrumb-item text-muted">
                <a href="#" class="text-muted text-hover-primary">
                    {{-- Drawstat --}}
                    @yield('table_name', 'Message Template')
                </a>
            </li>
            <!--end::Item-->
            <!--begin::Item-->
    ...
    <div class="d-flex align-items-center gap-lg-3 gap-2">
        ...
        <div class="m-0">
            <!--begin::Menu toggle-->
            @include('layouts.message.message_template.partials.partials.filterbtn')
            <!--end::Menu 1-->
        </div>
        <!--end::Filter menu-->
        ...
        <div class="m-0">
            @include('layouts.message.message_template.partials.partials.createbtn')
        </div>
        <!--end::Primary button-->
    </div>
    <!--end::Actions-->
