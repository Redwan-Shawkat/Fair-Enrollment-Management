...
Route::middleware('auth')->group(function(){
    ...
    Route::get('/productform',[ProductInterestController::class,'create'])->name('product.create');
    Route::post('/product',[ProductInterestController::class,'store'])->name('product.store');
});
